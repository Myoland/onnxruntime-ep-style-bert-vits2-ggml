...
次の通りです。この Windows 環境では既定の `coopmat` が
`vk::Device::getFenceStatus: ErrorDeviceLost` で完走しなかったため、下表は保守的な
`vulkan_math_mode=f32`, `precision=accurate` の確認値です。Engine checkout は
...
| label | text | ONNX CPU RTF | GGML Vulkan RTF | WAV preview |
| --- | --- | ---: | ---: | --- |
| short | `テストです。` | `0.428` | `0.187` | [ONNX CPU](res/benchmark-audio/20260705-windows-arc-b580-f32/onnx-cpu-short.wav) / [GGML Vulkan](res/benchmark-audio/20260705-windows-arc-b580-f32/onnx-ggml-vulkan-short.wav) |
| medium | `今日はいい天気ですね。` | `0.348` | `0.170` | [ONNX CPU](res/benchmark-audio/20260705-windows-arc-b580-f32/onnx-cpu-medium.wav) / [GGML Vulkan](res/benchmark-audio/20260705-windows-arc-b580-f32/onnx-ggml-vulkan-medium.wav) |
| long | `これは少し長めの文章です。GPUバックエンドの推論速度と音声品質を確認しています。` | `0.263` | `0.148` | [ONNX CPU](res/benchmark-audio/20260705-windows-arc-b580-f32/onnx-cpu-long.wav) / [GGML Vulkan](res/benchmark-audio/20260705-windows-arc-b580-f32/onnx-ggml-vulkan-long.wav) |
| average | - | `0.346` | `0.168` | - |
